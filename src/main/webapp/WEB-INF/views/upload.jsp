...
<body>
  <div class="left">
    <form action="upload_ok" method="post" enctype="multipart/form-data" onsubmit="return false;">
      <div id="previewGroup" style="display: flex; flex-direction: row;">
        <label id="fileUploadLabel" for="fileUpload" style="display: block; cursor: pointer;">
          <img id="selectButtonImg" alt="SelectButton" src="${CP}/resources/selectButton.jpg" width="400" height="400">
        </label>
        <!-- 파일 선택 -->
        ...
        <div id="cancelContainer">
          ...
          <button id="cancelButton" type="button" class="btn btn-link">
            <img alt="XButton" src="${CP}/resources/cancel.png">
          </button>
        </div>
      </div>
      <!-- 모델로 사진 전송, 실행 -->
  ...
  <div class="right" id="rightContent" style="display: none;">
    ...
    <div id="FeedbackButtons">
      <button id="likeButton" type="button" class="btn btn-link"><img src="${CP}/resources/thumbsup.jpg" alt="붐업 이미지"></button>
      <button id="dislikeButton" type="button" class="btn btn-link"><img src="${CP}/resources/thumbsdown.jpg" alt="붐따 이미지"></button>
    </div>
  ...
  <script>
    ...
    // "Run" 버튼 클릭 이벤트에 showRightContent 함수를 연결
    let runButton = document.getElementById('runButton');
    runButton.addEventListener('click', showRightContent);
